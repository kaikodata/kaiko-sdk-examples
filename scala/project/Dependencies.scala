...
object Dependencies {
  ...
  lazy val sdk = "com.kaiko" %% "scala-sdk" % "1.27.0"
  lazy val scalapbjson4s = "com.thesamet.scalapb" %% "scalapb-json4s" % "0.12.0"
  lazy val retry =
    "com.evanlennick" % "retry4j" % "0.15.0" // optional dependency only to demonstrate resubscribe
}
